...
return array(
	'phpunit' => array(
        ...
        // TODO - REMOVE Later, Autoloading for Old PhpUnit < 4.5
        // TODO - 'autoload_path' => VENDORPATH . 'PHPUnit/Autoload.php',

        'autoload_path' => VENDORPATH . 'autoload.php', // Autoload for PhpUnit 5+
        'binary_path'   => VENDORPATH . 'bin/phpunit',
	),
);
